...
4) For Chrome versions 33-49, it is recommended that you replace the ntdll.dll with the one from XP SP1.
4.1) You must have the system core files replaced with the one from XP SP1, for the following:
   
2.2) If you are using Windows XP RC 1 build 2481 - Windows XP RC 1 build 2509, you must replace the following files:
 imm32.dll (from Windows 2000 Extended Kernel)
 iphlpapi.dll and icmp.dll (from Windows XP SP3)
or it will not work.
