...
Since chrome_elf.dll was added on Chrome 33.0.1712.2 Dev, Chrome 33.0.1750.xxx-49.0.2623.xxx is unofficially possible on vanilla Windows 2000 & Windows Whistler build 2410 through Windows .NET Server Build 3590 unofficially, but it either triggers a crash or hang after the timeout (up to 60 seconds).
