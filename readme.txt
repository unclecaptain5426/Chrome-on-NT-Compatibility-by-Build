...
Chrome 4.0.249.89/5.0.312 Dev (Windows Whistler build 2410/2416+) Chrome 5.0.317+ does not work on Windows Whistler build 2410 through Windows XP build 2475 due to the wtsapi.dll change that will require upgrading to Windows XP Pre-RC 1 Build 2481
